...
exec rm -fr proj/cnn_fpga_pcie_v$today
exec mkdir proj/cnn_fpga_pcie_v$today

create_project -part xcku115-flva1517-2-e -force proj/cnn_fpga_pcie_v$today/cnn_fpga_pcie_v$today
...
import_files -force ../conv_neuron/conv_neuron_shmu.vhd
import_files -force ../conv_neuron_layer/conv_neuron_layer_ffanout_shmu.vhd
...
import_files -force ../stream_tools/stream_narrow_32to3.vhd
...
import_files -force vhdl/admpcie8k5_cnn_top.vhd
